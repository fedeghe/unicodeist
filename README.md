...
Clicking <a href="./src//img/fg.json?raw=true" download>here</a> you could download exactly that creative and import it in _unicodeist_ .... but 'm sure You can do way better that that 
